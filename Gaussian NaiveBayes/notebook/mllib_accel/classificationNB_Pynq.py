...
class Naivebayes(object):
    ...
    def train(self, trainRDD, _accel_ = 0):  
        ...
        Train a logistic regression model on the given data. 
            ...
            :param trainRDD:         The training data, an RDD of LabeledPoint.
  
            :param alpha:            The Laplasian parameter (default: 1.0).

            :param decision:         The decision of Distribution(Gaussian , Multinomial) (default: 1).

            :param _accel_:          0: SW-only, 1: HW accelerated (deafult: 0).

            :note:                   Labels used in logistic regression should be 
    ...
    def test(self, testRDD, _accel_ = 0):
            ...
            Test a logistic regression model on the given data.
                ...
                :param testRDD:    The testing data, an RDD of LabeledPoint.
