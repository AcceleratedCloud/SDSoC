...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:hls:NBprediction_accel:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: NBprediction_accel_1, and set properties
  set NBprediction_accel_1 [ create_bd_cell -type ip -vlnv xilinx.com:hls:NBprediction_accel:1.0 NBprediction_accel_1 ]

  # Create instance: NBprediction_accel_1_if, and set properties
  set NBprediction_accel_1_if [ create_bd_cell -type ip -vlnv xilinx.com:ip:adapter_v3_0:1.0 NBprediction_accel_1_if ]
  set_property -dict [ list \
   CONFIG.C_HAS_RETURN {1} \
   CONFIG.C_NUM_INPUT_FIFOs {4} \
   ...
   CONFIG.S_AXIS_FIFO_3_BYTE_WIDTH {32} \
   CONFIG.S_AXIS_FIFO_3_DEPTH {1024} \
   CONFIG.S_AXIS_FIFO_3_DMWIDTH {64} \
   CONFIG.S_AXIS_FIFO_3_WIDTH {32} \
 ] $NBprediction_accel_1_if
  ...
  connect_bd_intf_net -intf_net NBprediction_accel_1_data [get_bd_intf_pins NBprediction_accel_1/data] [get_bd_intf_pins NBprediction_accel_1_if/AP_FIFO_IARG_0]
  connect_bd_intf_net -intf_net NBprediction_accel_1_if_ap_ctrl [get_bd_intf_pins NBprediction_accel_1/ap_ctrl] [get_bd_intf_pins NBprediction_accel_1_if/ap_ctrl]
  connect_bd_intf_net -intf_net NBprediction_accel_1_means [get_bd_intf_pins NBprediction_accel_1/means] [get_bd_intf_pins NBprediction_accel_1_if/AP_FIFO_IARG_1]
  connect_bd_intf_net -intf_net NBprediction_accel_1_priors [get_bd_intf_pins NBprediction_accel_1/priors] [get_bd_intf_pins NBprediction_accel_1_if/AP_FIFO_IARG_3]
  connect_bd_intf_net -intf_net NBprediction_accel_1_variances [get_bd_intf_pins NBprediction_accel_1/variances] [get_bd_intf_pins NBprediction_accel_1_if/AP_FIFO_IARG_2]
  connect_bd_intf_net -intf_net axi_ic_ps7_M_AXI_GP0_M00_AXI [get_bd_intf_pins NBprediction_accel_1_if/S_AXI] [get_bd_intf_pins axi_ic_ps7_M_AXI_GP0/M00_AXI]
  ...
  connect_bd_intf_net -intf_net dm_0_M_AXIS_MM2S [get_bd_intf_pins NBprediction_accel_1_if/S_AXIS_FIFO_0] [get_bd_intf_pins dm_0/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net dm_1_M_AXIS_MM2S [get_bd_intf_pins NBprediction_accel_1_if/S_AXIS_FIFO_1] [get_bd_intf_pins dm_1/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net dm_2_M_AXIS_MM2S [get_bd_intf_pins NBprediction_accel_1_if/S_AXIS_FIFO_2] [get_bd_intf_pins dm_2/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net dm_3_M_AXIS_MM2S [get_bd_intf_pins NBprediction_accel_1_if/S_AXIS_FIFO_3] [get_bd_intf_pins dm_3/M_AXIS_MM2S]
  connect_bd_intf_net -intf_net dm_3_M_AXI_MM2S [get_bd_intf_pins axi_ic_ps7_S_AXI_ACP/S03_AXI] [get_bd_intf_pins dm_3/M_AXI_MM2S]
  ...
  connect_bd_net -net NBprediction_accel_1_ap_return [get_bd_pins NBprediction_accel_1/ap_return] [get_bd_pins NBprediction_accel_1_if/ap_oscalar_0_din]
  connect_bd_net -net NBprediction_accel_1_if_ap_clk [get_bd_pins NBprediction_accel_1/ap_clk] [get_bd_pins NBprediction_accel_1_if/ap_clk]
  connect_bd_net -net NBprediction_accel_1_if_ap_resetn [get_bd_pins NBprediction_accel_1/ap_rst_n] [get_bd_pins NBprediction_accel_1_if/ap_resetn]
  connect_bd_net -net axcache_0xE_dout [get_bd_pins axcache_0xE/dout] [get_bd_pins axi_ic_ps7_S_AXI_ACP/S00_AXI_arcache] [get_bd_pins axi_ic_ps7_S_AXI_ACP/S01_AXI_arcache] [get_bd_pins axi_ic_ps7_S_AXI_ACP/S02_AXI_arcache] [get_bd_pins axi_ic_ps7_S_AXI_ACP/S03_AXI_arcache]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins NBprediction_accel_1_if/acc_aclk] [get_bd_pins NBprediction_accel_1_if/s_axi_aclk] [get_bd_pins NBprediction_accel_1_if/s_axis_fifo_0_aclk] [get_bd_pins NBprediction_accel_1_if/s_axis_fifo_1_aclk] [get_bd_pins NBprediction_accel_1_if/s_axis_fifo_2_aclk] [get_bd_pins NBprediction_accel_1_if/s_axis_fifo_3_aclk] [get_bd_pins axi_ic_ps7_M_AXI_GP0/ACLK] [get_bd_pins axi_ic_ps7_M_AXI_GP0/M00_ACLK] [get_bd_pins axi_ic_ps7_M_AXI_GP0/M01_ACLK] [get_bd_pins axi_ic_ps7_M_AXI_GP0/M02_ACLK] [get_bd_pins axi_ic_ps7_M_AXI_GP0/M03_ACLK] [get_bd_pins axi_ic_ps7_M_AXI_GP0/M04_ACLK] [get_bd_pins axi_ic_ps7_M_AXI_GP0/S00_ACLK] [get_bd_pins axi_ic_ps7_S_AXI_ACP/ACLK] [get_bd_pins axi_ic_ps7_S_AXI_ACP/M00_ACLK] [get_bd_pins axi_ic_ps7_S_AXI_ACP/S00_ACLK] [get_bd_pins axi_ic_ps7_S_AXI_ACP/S01_ACLK] [get_bd_pins axi_ic_ps7_S_AXI_ACP/S02_ACLK] [get_bd_pins axi_ic_ps7_S_AXI_ACP/S03_ACLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins dm_0/m_axi_mm2s_aclk] [get_bd_pins dm_0/s_axi_lite_aclk] [get_bd_pins dm_1/m_axi_mm2s_aclk] [get_bd_pins dm_1/s_axi_lite_aclk] [get_bd_pins dm_2/m_axi_mm2s_aclk] [get_bd_pins dm_2/s_axi_lite_aclk] [get_bd_pins dm_3/m_axi_mm2s_aclk] [get_bd_pins dm_3/s_axi_lite_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins ps7/M_AXI_GP0_ACLK] [get_bd_pins ps7/S_AXI_ACP_ACLK]
  ...
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins axi_ic_ps7_M_AXI_GP0/ARESETN] [get_bd_pins axi_ic_ps7_M_AXI_GP0/M00_ARESETN] [get_bd_pins axi_ic_ps7_M_AXI_GP0/M01_ARESETN] [get_bd_pins axi_ic_ps7_M_AXI_GP0/M02_ARESETN] [get_bd_pins axi_ic_ps7_M_AXI_GP0/M03_ARESETN] [get_bd_pins axi_ic_ps7_M_AXI_GP0/M04_ARESETN] [get_bd_pins axi_ic_ps7_M_AXI_GP0/S00_ARESETN] [get_bd_pins axi_ic_ps7_S_AXI_ACP/ARESETN] [get_bd_pins axi_ic_ps7_S_AXI_ACP/M00_ARESETN] [get_bd_pins axi_ic_ps7_S_AXI_ACP/S00_ARESETN] [get_bd_pins axi_ic_ps7_S_AXI_ACP/S01_ARESETN] [get_bd_pins axi_ic_ps7_S_AXI_ACP/S02_ARESETN] [get_bd_pins axi_ic_ps7_S_AXI_ACP/S03_ARESETN] [get_bd_pins proc_sys_reset_0/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins NBprediction_accel_1_if/acc_aresetn] [get_bd_pins NBprediction_accel_1_if/s_axi_aresetn] [get_bd_pins NBprediction_accel_1_if/s_axis_fifo_0_aresetn] [get_bd_pins NBprediction_accel_1_if/s_axis_fifo_1_aresetn] [get_bd_pins NBprediction_accel_1_if/s_axis_fifo_2_aresetn] [get_bd_pins NBprediction_accel_1_if/s_axis_fifo_3_aresetn] [get_bd_pins dm_0/axi_resetn] [get_bd_pins dm_1/axi_resetn] [get_bd_pins dm_2/axi_resetn] [get_bd_pins dm_3/axi_resetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x01000000 -offset 0xFC000000 [get_bd_addr_spaces dm_2/Data_MM2S] [get_bd_addr_segs ps7/S_AXI_ACP/ACP_QSPI_LINEAR] SEG_ps7_ACP_QSPI_LINEAR
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces dm_3/Data_MM2S] [get_bd_addr_segs ps7/S_AXI_ACP/ACP_DDR_LOWOCM] SEG_ps7_ACP_DDR_LOWOCM
  create_bd_addr_seg -range 0x01000000 -offset 0xFC000000 [get_bd_addr_spaces dm_3/Data_MM2S] [get_bd_addr_segs ps7/S_AXI_ACP/ACP_QSPI_LINEAR] SEG_ps7_ACP_QSPI_LINEAR
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs NBprediction_accel_1_if/S_AXI/reg0] SEG_NBprediction_accel_1_if_reg0
  ...
  exclude_bd_addr_seg [get_bd_addr_segs dm_2/Data_MM2S/SEG_ps7_ACP_IOP]
  ...
  exclude_bd_addr_seg [get_bd_addr_segs dm_2/Data_MM2S/SEG_ps7_ACP_M_AXI_GP0]

  create_bd_addr_seg -range 0x00400000 -offset 0xE0000000 [get_bd_addr_spaces dm_3/Data_MM2S] [get_bd_addr_segs ps7/S_AXI_ACP/ACP_IOP] SEG_ps7_ACP_IOP
  exclude_bd_addr_seg [get_bd_addr_segs dm_3/Data_MM2S/SEG_ps7_ACP_IOP]

  create_bd_addr_seg -range 0x40000000 -offset 0x40000000 [get_bd_addr_spaces dm_3/Data_MM2S] [get_bd_addr_segs ps7/S_AXI_ACP/ACP_M_AXI_GP0] SEG_ps7_ACP_M_AXI_GP0
  exclude_bd_addr_seg [get_bd_addr_segs dm_3/Data_MM2S/SEG_ps7_ACP_M_AXI_GP0]
